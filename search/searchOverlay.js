    ...
    <div class="px-4 py-4 md:py-6 border-b border-gray-100 flex-shrink-0">
        <div class="max-w-3xl mx-auto flex items-center justify-between gap-4">
            ...
            <div class="flex-1 relative bg-gray-100 rounded-full group hover:bg-gray-200 transition-colors">
                ...
                <button id="clearSearchInput" class="absolute inset-y-0 right-0 pr-3 flex items-center hidden text-gray-400 hover:text-black" aria-label="Xóa tìm kiếm">
                    <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z" clip-rule="evenodd"></path></svg>
                </button>
            </div>
